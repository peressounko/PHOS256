...
void Config()
{
  ...
  GenPythia* gen = new GenPythia("/home/prsnko/alice/sw/ubuntu2204_x86-64/pythia/v8311-26/share/Pythia8/htmldoc");
  //  gen->SetMomentumRange(0.5,1.);
  //  gen->SetThetaRange(0.,10.);
  //  gen->SetPhiRange(0.,360.);
  gen->Initialize(2212, 2212, 60.);

  gSim->SetGenerator(gen);

  // Construct PHOS
  Phos* ph = new Phos(10., 20.); // Distance to crystal, angle
  gSim->SetPHOS(ph);
